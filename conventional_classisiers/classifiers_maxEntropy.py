...
print "Max Entropy classifiers trained"
count_me=0
...
for line in test_data:
  ...
  decision2=MaxEntClassifier.classify(gvector_review)
  
  if decision2==sentiment:
   count_me+=1

accuracy_me=float(count_me)/len(test_data)
print "accuracy Max Entropy Classifer",accuracy_me
